...
function showChoiceScreen() {
    document.getElementById("content").innerHTML = `
        ...
        <button onclick="chooseQuiz()">カード</button>
    `;
}
...
function chooseOption(selectedChoice) {
    ...
    document.getElementById("content").innerHTML = `
        ...
        <br>
        <button onclick="showChoiceScreen()">ドリルを変える</button>
    `;
}

// クイズの教材画面を表示する関数
function chooseQuiz() {
    window.location.href = 'WordViewerQuiz.html';
}
...
function showWordViewer(grade) {
    ...
    document.getElementById("content").innerHTML = `
        ...
        <br>
        <br>
        <button onclick="chooseOption()">学年を変える</button>
    `;
